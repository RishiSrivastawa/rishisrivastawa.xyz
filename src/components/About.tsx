...
const education = [
  {
    ...
    grade: 7.59,
    description:
      "Pursuing Bachelor's in Computer Science with focus on software development, data structures, and algorithms.",
  },
  {
    title: "12th",
    institution: "Sunbeam School, Mughalsarai, UP, IN",
    period: "2020-2021",
    grade: 83,
    description:
  ...
  {
    title: "10th",
    institution: "St. Mary's Convent School, Mughalsarai, UP, IN",
    period: "2018-2019",
    grade: 86,
    description:
...
const experience = [
  {
    ...
    period: "2022-Present",
    description:
      "Building anything from small python scripts to fullstack end to end applications to complex webscraping engines controlled via a simple dashboard.",
  },
];
          ...
          <div className="text-center mb-20">
            ...
            >
              <Avatar className="w-40 h-40 mx-auto mb-6 ring-4 ring-emerald-500/30 shadow-xl">
                <AvatarImage
                  src="/profile.jpg" // put profile.jpg in the /public folder
                  alt="Rishi Srivastawa"
                ...
                {education.map((edu, index) => (
                  ...
                  >
                    ...
                    <div className="mb-4">
                      ...
                      {edu.grade == 7.59 ? (
                        <p className="text-gray-300">Grade: {edu.grade} CGPA</p>
                      ) : (
